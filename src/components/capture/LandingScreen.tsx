    ...
    <div className="relative w-full h-[100dvh] bg-black text-white overflow-hidden font-sans select-none touch-none">
      ...
      <div className="relative z-10 w-full h-full flex flex-row">
        ...
        <button
          ...
          className="group relative flex-1 h-full flex flex-col items-center justify-center border-r border-white/10 active:bg-white/[0.05] transition-all duration-300 focus:outline-none tap-highlight-transparent"
        >
          {/* Gradient: 
              - Mobile (default): opacity-100 (Always visible)
              - Desktop (sm): opacity-0 (Hidden until hover) 
          */}
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/0 to-emerald-500/5 transition-opacity duration-300 
            opacity-100 
          ...
          <div className="relative z-10 flex flex-col items-center text-center pr-8 sm:pr-0">
            {/* Icon Circle:
                - Mobile: Green border & Shadow always on
                - Desktop: Grey border, Green only on hover
            */}
            <div className="mb-3 p-3 rounded-full bg-neutral-900/50 transition-all duration-300 
              border border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.2)] scale-100
              sm:border-white/10 sm:shadow-none sm:group-hover:border-emerald-500/50 sm:group-hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] sm:group-hover:scale-110"
            >
              <Bike className="w-6 h-6 sm:w-10 sm:h-10 transition-colors 
                text-emerald-400 
                sm:text-neutral-400 sm:group-hover:text-emerald-400" 
              />
            </div>
        ...
        <button
          ...
          className="group relative flex-1 h-full flex flex-col items-center justify-center border-l border-white/10 active:bg-white/[0.05] transition-all duration-300 focus:outline-none tap-highlight-transparent"
        >
          {/* Gradient: Always visible on Mobile, Hover on Desktop */}
          <div className="absolute inset-0 bg-gradient-to-l from-cyan-900/0 to-cyan-500/5 transition-opacity duration-300 
            opacity-100 
            sm:opacity-0 sm:group-hover:opacity-100" 
          />
          
          <div className="relative z-10 flex flex-col items-center text-center pl-8 sm:pl-0">
            {/* Icon Circle: Cyan glow always on Mobile */}
            <div className="mb-3 p-3 rounded-full bg-neutral-900/50 transition-all duration-300
              border border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.2)] scale-100
              sm:border-white/10 sm:shadow-none sm:group-hover:border-cyan-500/50 sm:group-hover:shadow-[0_0_20px_rgba(6,182,212,0.2)] sm:group-hover:scale-110"
            >
              <Home className="w-6 h-6 sm:w-10 sm:h-10 transition-colors 
                text-cyan-400 
                sm:text-neutral-400 sm:group-hover:text-cyan-400" 
              />
            </div>
